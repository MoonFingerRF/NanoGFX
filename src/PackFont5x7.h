// ============================================================================
//  PackFont5x7.h — the canonical 5x7 "classic" GLCD font, byte-for-byte the table
//  Adafruit_GFX ships in glcdfont.c (which declares it `static`, so it cannot be
//  linked against). Embedded here so PackCanvas's dual-parity text blitter renders
//  EXACTLY what Adafruit_GFX::drawChar renders, and so NanoGFX stays fully
//  self-contained. Original data (c) Adafruit Industries, BSD license.
// ============================================================================
#pragma once
#include <stdint.h>
